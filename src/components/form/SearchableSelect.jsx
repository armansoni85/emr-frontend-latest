...
const SearchableSelect = ({
    ...
    const calculateDropdownPosition = () => {
        ...
        const dropdownHeight = dropdownContainer.current ? dropdownContainer.current.offsetHeight + inputRect.height + 5 : 0;
        ...
        if (defaultValue) {
            const defaultOption = options.find(
                (option) =>
                    ...
                    (typeof keyValue === "function" ? keyValue(defaultValue) : defaultValue)
            );
            if (defaultOption) {
