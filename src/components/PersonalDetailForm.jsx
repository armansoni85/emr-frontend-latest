...
const PersonalDetailForm = ({ isReadOnly = true, wrapperClassName = "" }) => {
    ...
    return (
        <div className={`grid lg:grid-cols-2 grid-cols-1 gap-4 ${wrapperClassName}`}>
            <div className="p-4">
                <InputWithLabel
                    ...
                    onChange={(e) => handleFormChange("firstName", e.target.value, setForms)}
                    readOnly={isReadOnly}
                />
                <InputWithLabel
                    wrapperClassName={"mb-3"}
                ...
                <InputWithLabel
                    ...
                    type={"select"}
                    value={forms.country}
                    onChange={(e) => handleFormChange("country", e.target.value, setForms)}
                    readOnly={isReadOnly}>
                    <EachLoop
                        of={countryCodes}
                        render={(item) => {
            ...
            <div className="p-4">
                <InputWithLabel
                    ...
                    onChange={(e) => handleFormChange("lastName", e.target.value, setForms)}
                    readOnly={isReadOnly}
                />
                <InputWithLabel
                    wrapperClassName={"mb-3"}
                ...
                <InputWithLabel
                    ...
                    onChange={(e) => handleFormChange("mobileNumber", e.target.value, setForms)}
                    readOnly={isReadOnly}
                />
                <InputWithLabel
                    wrapperClassName={"mb-3"}
                    ...
                    onChange={(e) => handleFormChange("residentalAddress", e.target.value, setForms)}
                    readOnly={isReadOnly}
                />
            </div>
        </div>
