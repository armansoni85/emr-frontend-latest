            ...
            <div className="bg-white shadow-md rounded-2xl pb-4">
                <div className="flex justify-between p-4 border-b-2 rounded-t-2xl bg-grey bg-opacity-[0.4] shadow shadow-b">
                    ...
                    <div className="text-end inline-block">
                        <button className="bg-primary text-white rounded-full h-8 w-8 text-2xl">+</button>
                    </div>
                </div>
                        ...
                        <thead>
                            <tr>
                                <th className="py-2 px-4 border-b text-start font-medium">
                                    Doctor Name <i className="material-icons align-middle">arrow_drop_down</i>
                                </th>
                                ...
                                <th className="py-2 px-4 border-b text-start font-medium">Reason of Visit</th>
