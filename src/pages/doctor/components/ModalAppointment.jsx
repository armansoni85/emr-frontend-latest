                    ...
                    <table className="min-w-full bg-white overflow-x-auto text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th className="py-2 px-4 text-start font-medium">Date &amp; Time</th>
                                <th className="py-2 px-4 text-start font-medium">Disease</th>
                                <th className="py-2 px-4 text-start font-medium">Reason Of Visit</th>
                                <th className="py-2 px-4 text-start font-medium">AI Visit Notes Status</th>
                            </tr>
                        </thead>
                        <tbody className="text-body">
                            <tr>
                                ...
                                <td className="py-2 px-4">August 1, 2024 - 9:00AM</td>
                                <td className="py-2 px-4">
                                    <Badge color="info">{appointment?.disease}</Badge>
                                </td>
                                <td className="py-2 px-4">{appointment.reason_of_visit}</td>
                                <td className="py-2 px-4">{StatusText(appointment.appointment_status)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex justify-between w-full text-nowrap">
                                ...
                                <div className="text-end">
                                    ...
                                    <p className="mt-7 text-sm">Status: {StatusText(appointment.appointment_status)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
