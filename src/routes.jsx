import { AIChatSupportPage, AIVisitNotesPage, ChatWithAgentPage, EmailSupportPage, PatientAddPage, PatientListPage } from "./pages/doctor";
import { AppointmentAddPage, AppointmentPage } from "./pages/doctor/appointment";
import { AppointmentForm, PastPage, UpComingPage } from "./pages/patient/appointment";
import { ChangePassword, PrivateLayout } from "./components";
import { CustomColorThemePage, CustomIntegrationPage, CustomNotificationPage } from "./pages/doctor/cusomization";
import { EFaxDeliveryPage, EmailDeliveryPage } from "./pages/doctor/consultation";
import { EditProfilePage, PatientProfileLayout, ProfilePage } from "./pages/patient/profile";
import { HippaCompliancePage, UserAccessControlPage } from "./pages/doctor/security";
...
import { PersonalDetailPage, ProfessionalInformationPage, ScheduleAndAvailabilityPage } from "./pages/doctor/profile";
import { PrescriptionAddPage, PrescriptionListPage } from "./pages/doctor/prescription";
